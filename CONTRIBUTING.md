# Contributing to LlamaScale

Thank you for your interest in contributing to LlamaScale! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaScale:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamascale.git
   cd llamascale
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamascale.git
   ```
...
By contributing to LlamaScale, you agree that your contributions will be licensed under the project's MIT License.
