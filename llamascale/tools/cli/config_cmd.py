...
def add_config_args(subparsers):
    ...
    parser_set.add_argument(
        "key",
        help="Configuration key (e.g. 'mlx_config.thread_count')"
    )
    parser_set.add_argument(
        "value",
    ...
    parser_add_model = subparsers.add_parser(
        "config-add-model", 
        help="Add a model to the configuration"
    )
    ...
    parser_remove_model = subparsers.add_parser(
        "config-remove-model", 
        help="Remove a model from the configuration"
    )
    parser_remove_model.add_argument(
        "name",
        help="Model name"
    )
    parser_remove_model.add_argument(
