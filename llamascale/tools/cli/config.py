...
class ConfigManager:
    ...
    def _update_config_from_dict(self, config: LlamaScaleConfig, config_dict: Dict[str, Any]):
    ...
    def _update_cache_config(self, cache_config: CacheConfig, config_dict: Dict[str, Any]):
