...
class LlamaScaleClient:
    ...
    async def generate(
        ...
        if stream:
            ...
            raise ValueError(
                "Streaming is not supported in the generate method. Use generate_stream instead."
            )
    ...
    async def create_agent(
        ...
        """
        data = {"name": name, "model": model, "reasoning_strategy": reasoning_strategy}
...
class LlamaScaleClientSync:
    ...
    def execute_tool_call(self, tool_call: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.loop.run_until_complete(
            self.async_client.execute_tool_call(tool_call)
        )
